...
Jack Grigg (26):
      ...
      Rationalize currency unit to "ZEN"
...
Simon Liu (5):
      ...
      Closes #2637. Make z_shieldcoinbase an experimental feature where it     can be enabled with: zend -experimentalfeatures -zshieldcoinbase.
