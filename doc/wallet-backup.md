...
Backing up your ZenCash private keys is the best way to be proactive about preventing loss of access to your ZEN.
...
These instructions are specific for the officially supported ZenCash Linux client. For backing up with third-party wallets, please consult with user guides or support channels provided for those services.

There are multiple ways to make sure you have at least one other copy of the private keys needed to spend your ZEN and view your shielded ZEN.
...
Note that zend will need to be stopped and restarted for edits in the config file to take effect. 
...
If you generate a new ZenCash address, it will not be reflected in the backup file.
